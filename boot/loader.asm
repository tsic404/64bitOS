...
;======         found  kernel.bin name in r4oot director struct
...
;====== init IDT GDT goto ptotect mode
...
GetMemStructOKMessage:      db          "Get Memory Struct SUCCESSSFUL!"
